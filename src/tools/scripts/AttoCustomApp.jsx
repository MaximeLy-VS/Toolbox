...
const REGLES_TYPO_REMPLACEMENT = [
  ...
  { regex: /(?<=\d[\s\u00A0]*)j\b/gi, replace: 'J' },
  { regex: /(?<=\d[\s\u00A0]*)(kj)\b/gi, replace: 'kJ' },
  { regex: /(?<=\d[\s\u00A0]*)(cal)\b/gi, replace: 'cal' },
  { regex: /(?<=\d[\s\u00A0]*)(kcal)\b/gi, replace: 'kcal' },
  { regex: /(?<=\d[\s\u00A0]*)(wh)\b/gi, replace: 'Wh' },
  { regex: /(?<=\d[\s\u00A0]*)(kwh|kW-h)\b/gi, replace: 'kWh' },
  { regex: /(?<=\d[\s\u00A0]*)(ko)\b/gi, replace: 'ko' },
  { regex: /(?<=\d[\s\u00A0]*)(mo)\b/gi, replace: 'Mo' },
  { regex: /(?<=\d[\s\u00A0]*)(go)\b/gi, replace: 'Go' },
  { regex: /(?<=\d[\s\u00A0]*)(to)\b/gi, replace: 'To' },
  { regex: /(?<=\d[\s\u00A0]*)(hz)\b/gi, replace: 'Hz' },
  { regex: /(?<=\d[\s\u00A0]*)(khz)\b/gi, replace: 'KHz' },
  { regex: /(?<=\d[\s\u00A0]*)(mhz)\b/gi, replace: 'MHz' },
  { regex: /(?<=\d[\s\u00A0]*)(ghz)\b/gi, replace: 'GHz' },
  { regex: /(?<=\d[\s\u00A0]*)(kg)\b/gi, replace: 'kg' },
  { regex: /(?<=\d[\s\u00A0]*)(hg)\b/gi, replace: 'hg' },
  { regex: /(?<=\d[\s\u00A0]*)g\b/g, replace: 'g' },
  { regex: /(?<=\d[\s\u00A0]*)(dg)\b/gi, replace: 'dg' },
  { regex: /(?<=\d[\s\u00A0]*)(cg)\b/gi, replace: 'cg' },
  { regex: /(?<=\d[\s\u00A0]*)(mg)\b/gi, replace: 'mg' },
  { regex: /(?<=\d[\s\u00A0]*)(ug)\b/gi, replace: 'µg' },
  { regex: /(?<=\d[\s\u00A0]*)(km)\b/gi, replace: 'km' },
  { regex: /(?<=\d[\s\u00A0]*)m\b/g, replace: 'm' },
  { regex: /(?<=\d[\s\u00A0]*)(dm)\b/gi, replace: 'dm' },
  { regex: /(?<=\d[\s\u00A0]*)(cm)\b/gi, replace: 'cm' },
  { regex: /(?<=\d[\s\u00A0]*)(mm)\b/gi, replace: 'mm' },
];
