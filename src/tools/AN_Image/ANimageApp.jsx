      ...
      <div className="w-full max-w-7xl bg-white rounded-[2rem] shadow-[0_30px_100px_rgba(0,0,0,0.08)] overflow-hidden flex flex-col md:flex-row border border-slate-100 animate-fade-slide-up">
        ...
        <div className="md:w-[42%] p-8 md:p-12 flex flex-col border-r border-slate-50 bg-white">
          ...
          <div
            ...
            className={`flex-1 flex flex-col items-center justify-center p-8 border-2 border-dashed rounded-[2rem] transition-all bg-white relative mb-6 hover:border-indigo-300
            ...
            {previewUrl ? (
              ...
              <div className="animate-fade-slide-up flex-1 p-8 text-center cursor-pointer hover:bg-white transition-all duration-300 ease-in-out flex flex-col items-center justify-center group">
                <div className="w-20 h-20 bg-white rounded-[1.5rem] shadow-sm border border-slate-50 flex items-center justify-center mb-5 group-hover:scale-105 transition-transform group-hover:shadow-lg mx-auto">
                  <UploadCloud className="text-blue-600 mx-auto" size={32} />
                </div>
