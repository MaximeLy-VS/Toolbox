...
import {   Upload as IconUpload, UploadCloud, Image as IconImage, Copy as IconCopy, Check as IconCheck, AlertCircle as IconAlert, Form as IconForm, Loader2 as IconLoader, Info, Brain, Table as IconTable, Layout as IconLayout, ArrowRight, Wrench, ChevronLeft, ChevronRight, Sparkles, Wand2 as IconWand, Download, Zap, FileText as IconText} from 'lucide-react';
        ...
        <div className="md:w-[42%] p-8 md:p-12 flex flex-col border-r border-slate-50 bg-white">
          ...
          >
            ...
            {previewUrl ? (
              ...
              <div className="animate-fade-slide-up flex-1 border-2 border-dashed border-slate-200 rounded-[2rem] p-8 text-center cursor-pointer hover:border-indigo-400 hover:bg-white transition-all duration-300 ease-in-out flex flex-col items-center justify-center group">
