 ...
 const handleGenerateImage = async () => {
  ...
  return (
    <div>
      ...
      `}</style>
      <div className="w-full bg-white rounded-[2rem] shadow-2xl shadow-black-100 overflow-hidden flex flex-col md:flex-row border border-slate-100 animate-fade-slide-up">
