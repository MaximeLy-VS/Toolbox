...
const Home = () => (
  <div className="min-h-screen flex flex-col items-center justify-center p-6">
    ...
    <div className="flex flex-col text-left">
      <h2 className="text-3xl font-semibold text-slate-600 my-4 tracking-tight text-left">Outils d'analyse pour l'accessibilité numérique</h2>
      ...
      <h2 className="text-3xl font-semibold text-slate-600 my-4 tracking-tight text-left">Outils d'édition d'images</h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
            {[
