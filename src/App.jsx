...
const Home = () => (
  <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
      {[
        { to: "/tools/AN_Image", title: "Assistant Images", desc: "Accessibilité IA.", icon: IconImage, color: "bg-blue-600" },
        { to: "/tools/AN_tableau", title: "Assistant Tableaux", desc: "Extraction données.", icon: IconTable, color: "bg-indigo-600" },
        { to: "/tools/Mockup_app", title: "Mock-up Studio", desc: "Rendus design.", icon: IconLayout, color: "bg-purple-600" }
      ].map((tool, i) => (
